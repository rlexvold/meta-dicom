...
/**
 * Serializes java.util.Maps into XML-RPC structs. For each value in the map it
 * recursively calls the XmlRpcSerializer, which potentially ends up back in
 * this class if a value in the Map is another Map. The key should be a String
...
public class MapSerializer implements XmlRpcCustomSerializer
{
	 ...
	 * (Documentation inherited)
	 * 
	 * @see redstone.xmlrpc.XmlRpcCustomSerializer#serialize(java.lang.Object,
	 * java.io.Writer, redstone.xmlrpc.XmlRpcSerializer)
	 */
