 ...
 * @since 2.1
 * @version $Id: DurationFormatUtils.java,v 1.1 2008/07/14 19:24:35 rlexvold Exp $
 */
public class DurationFormatUtils
{
	...
	/**
	 * <p>
	 * Get the time gap as a string, using the specified format, and padding
	...
	/**
	 * <p>
	 * Get the time gap as a string, using the specified format. Padding the
	...
	public static String formatPeriod(long startMillis, long endMillis, String format, boolean padWithZeros, TimeZone timezone)
	{
		...
		if (millis < 28 * DateUtils.MILLIS_PER_DAY) { return formatDuration(millis, format, padWithZeros); }
		Token[] tokens = lexx(format);
	 ...
	 * amount and fixes and returns the amount to change by.
	 * 
	 * @param start
	 *            Start of period being formatted
	 * @param end
	 *            End of period being formatted
	 * @param field
	 *            Field to reduce, as per constants in
	...
	static class Token
	{
		...
		public boolean equals(Object obj2)
		{
			if (obj2 instanceof Token)
			{
				...
				if (this.value.getClass() != tok2.value.getClass()) { return false; }
				if (this.count != tok2.count) { return false; }
