 ...
 * @since 2.0
 * @version $Id: StopWatch.java,v 1.1 2008/07/14 19:24:34 rlexvold Exp $
 */
public class StopWatch
{
	...
	public void start()
	{
		if (this.runningState == STATE_STOPPED) { throw new IllegalStateException("Stopwatch must be reset before being restarted. "); }
