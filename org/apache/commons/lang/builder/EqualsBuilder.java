 ...
 * @since 1.0
 * @version $Id: EqualsBuilder.java,v 1.1 2008/07/14 19:24:34 rlexvold Exp $
 */
public class EqualsBuilder
{
	...
	public static boolean reflectionEquals(Object lhs, Object rhs, boolean testTransients, Class reflectUpToClass)
	{
		...
		{
			testClass = lhsClass;
			if (!rhsClass.isInstance(lhs)) // rhsClass is a subclass of
											// lhsClass
				testClass = rhsClass;
		} else if (rhsClass.isInstance(lhs))
		{
			testClass = rhsClass;
			if (!lhsClass.isInstance(rhs)) // lhsClass is a subclass of
											// rhsClass
				testClass = lhsClass;
