 ...
 * 
 * <p>
 * Alternatively, there is are {@link #reflectionCompare reflectionCompare}
 * method that uses reflection to determine the fields to append. Because fields
 * can be private, <code>reflectionCompare</code> uses
 ...
 * @author Pete Gieser
 * @since 1.0
 * @version $Id: CompareToBuilder.java,v 1.1 2008/07/14 19:24:34 rlexvold Exp $
 */
public class CompareToBuilder
{
	 ...
	 * 
	 * <p>
	 * If both <code>lhs</code> and <code>rhs</code> are <code>null</code>,
	 ...
	 * compares transient members. Otherwise ignores them, as they are likely
	 * derived fields.</li>
	 * <li>Superclass fields will be compared</li>
	 * </ul>
	 * 
	 ...
	 *         <code>rhs</code>
	 * @throws NullPointerException
	 *             if either <code>lhs</code> or <code>rhs</code> (but not
	 *             both) is <code>null</code>
	 * @throws ClassCastException
	 *             if <code>rhs</code> is not assignment-compatible with
	 *             <code>lhs</code>
	 */
	...
	private static void reflectionAppend(Object lhs, Object rhs, Class clazz, CompareToBuilder builder, boolean useTransients)
	{
		...
		{
			Field f = fields[i];
			if ((f.getName().indexOf('$') == -1) && (useTransients || !Modifier.isTransient(f.getModifiers())) && (!Modifier.isStatic(f.getModifiers()))) try
			{
	 ...
	 * 
	 * <p>
	 * <code>lhs</code> must either be an array or implement
	 * {@link Comparable}.
	 * </p>
	 * 
	 * @param lhs
	 ...
	 * must implement {@link Comparable} instead.
	 * </p>
	 * 
	 * @param lhs
	 *            left-hand object
	...
	public CompareToBuilder append(Object lhs, Object rhs, Comparator comparator)
	{
		...
		else comparison = comparator.compare(lhs, rhs);
		return this;
	}
	 ...
	 *            right-hand array
	 * @param comparator
	 *            <code>Comparator</code> to use to compare the array
