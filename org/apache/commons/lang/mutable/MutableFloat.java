 ...
 * @see Float
 * @since 2.1
 * @version $Id: MutableFloat.java,v 1.1 2008/07/14 19:24:36 rlexvold Exp $
 */
public class MutableFloat extends Number implements Comparable, Mutable
{
	 ...
	 * {@link Float#floatToIntBits(float)}returns the same int value when
	 * applied to each.
	 * <p>
	 * Note that in most cases, for two instances of class <code>Float</code>,<code>f1</code>
	 * and <code>f2</code>, the value of <code>f1.equals(f2)</code> is
	 ...
	 * <code>true</code>, even though <code>Float.NaN==Float.NaN</code> has
	 * the value <code>false</code>.
	 * <li>If <code>f1</code> represents <code>+0.0f</code> while
	 * <code>f2</code> represents <code>-0.0f</code>, or vice versa, the
	 * <code>equal</code> test has the value <code>false</code>, even
	 * though <code>0.0f==-0.0f</code> has the value <code>true</code>.
	 * </ul>
