 ...
 * @see Byte
 * @since 2.1
 * @version $Id: MutableByte.java,v 1.1 2008/07/14 19:24:36 rlexvold Exp $
 */
public class MutableByte extends Number implements Comparable, Mutable
{
	 ...
	 * and is a <code>MutableByte</code> object that contains the same
	 * <code>byte</code> value as this object.
	 * 
	 * @param obj
	...
	{
		if (obj instanceof MutableByte) { return value == ((MutableByte) obj).byteValue(); }
		return false;
	}
