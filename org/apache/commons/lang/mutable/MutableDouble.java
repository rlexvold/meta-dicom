 ...
 * @see Double
 * @since 2.1
 * @version $Id: MutableDouble.java,v 1.1 2008/07/14 19:24:36 rlexvold Exp $
 */
public class MutableDouble extends Number implements Comparable, Mutable
{
	 ...
	 * and is a <code>Double</code> object that represents a double that has
	 * the identical bit pattern to the bit pattern of the double represented by
	 ...
	 * <code>true</code>, even though <code>Double.NaN==Double.NaN</code>
	 ...
	 * though <code>+0.0==-0.0</code> has the value <code>true</code>. This
