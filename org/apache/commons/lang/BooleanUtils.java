 ...
 * @author Gary Gregory
 * @since 2.0
 * @version $Id: BooleanUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class BooleanUtils
{
	...
	/**
	 * <p>
	 * Is a Boolean value <code>true</code>, handling <code>null</code>.
	 * </p>
	 * 
	 * <pre>
	...
	/**
	 * <p>
	 * Is a Boolean value <code>false</code>, handling <code>null</code>.
	 * </p>
	 * 
	 * <pre>
	...
	public static boolean toBoolean(Integer value, Integer trueValue, Integer falseValue)
	{
		...
		{
			return true;
		} else if (value.equals(falseValue)) { return false; }
		// no match
		throw new IllegalArgumentException("The Integer did not match either specified value");
	}
	...
	public static Boolean toBooleanObject(Integer value, Integer trueValue, Integer falseValue, Integer nullValue)
	{
		if (value == null)
		{
			...
			{
				return Boolean.FALSE;
			} else if (nullValue == null) { return null; }
		} else if (value.equals(trueValue))
		{
			return Boolean.TRUE;
		...
		{
			return Boolean.FALSE;
		} else if (value.equals(nullValue)) { return null; }
		// no match
		throw new IllegalArgumentException("The Integer did not match any specified value");
	}
	...
	public static Boolean toBooleanObject(String str, String trueString, String falseString, String nullString)
	{
		if (str == null)
		{
			...
			{
				return Boolean.FALSE;
			} else if (nullString == null) { return null; }
		...
		{
			return Boolean.FALSE;
		} else if (str.equals(nullString)) { return null; }
		// no match
	...
	public static boolean toBoolean(String str)
	{
		...
		switch (str.length())
		{
			...
			{
				char ch = str.charAt(0);
				if (ch == 't') { return (str.charAt(1) == 'r' || str.charAt(1) == 'R') && (str.charAt(2) == 'u' || str.charAt(2) == 'U')
	...
	public static boolean toBoolean(String str, String trueString, String falseString)
	{
		if (str == null)
		{
			...
			{
				return true;
			} else if (falseString == null) { return false; }
		} else if (str.equals(trueString))
		{
			return true;
		} else if (str.equals(falseString)) { return false; }
		// no match
	...
	public static boolean xor(boolean[] array)
	{
		...
		} else if (array.length == 0) { throw new IllegalArgumentException("Array is empty"); }
