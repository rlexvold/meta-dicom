 ...
 * @since 2.0
 * @version $Id: ArrayUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class ArrayUtils
{
	...
	public static Map toMap(Object[] array)
	{
		...
		for (int i = 0; i < array.length; i++)
		{
			...
			} else if (object instanceof Object[])
			{
				...
				if (entry.length < 2) throw new IllegalArgumentException("Array element " + i + ", '" + object + "', has a length less than 2");
				map.put(entry[0], entry[1]);
			} else throw new IllegalArgumentException("Array element " + i + ", '" + object + "', is neither of type Map.Entry nor an Array");
		}
		return map;
	}
	...
	public static Object[] subarray(Object[] array, int startIndexInclusive, int endIndexExclusive)
	{
		...
		if (newSize <= 0) return (Object[]) Array.newInstance(type, 0);
	...
	public static int lastIndexOf(Object[] array, Object objectToFind, int startIndex)
	{
		...
		if (objectToFind == null)
		{
			for (int i = startIndex; i >= 0; i--)
				if (array[i] == null) return i;
		} else for (int i = startIndex; i >= 0; i--)
			if (objectToFind.equals(array[i])) return i;
		return -1;
	}
	...
	{
		if (ArrayUtils.isEmpty(array)) return -1;
		if (startIndex < 0) startIndex = 0;
		for (int i = startIndex; i < array.length; i++)
			if (valueToFind == array[i]) return i;
		return -1;
	...
	public static Long[] toObject(long[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_LONG_OBJECT_ARRAY;
		final Long[] result = new Long[array.length];
		for (int i = 0; i < array.length; i++)
	...
	public static Integer[] toObject(int[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_INTEGER_OBJECT_ARRAY;
	...
	public static short[] toPrimitive(Short[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_SHORT_ARRAY;
	...
	public static Short[] toObject(short[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_SHORT_OBJECT_ARRAY;
		final Short[] result = new Short[array.length];
		for (int i = 0; i < array.length; i++)
	...
	public static byte[] toPrimitive(Byte[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_BYTE_ARRAY;
	...
	public static Byte[] toObject(byte[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_BYTE_OBJECT_ARRAY;
		final Byte[] result = new Byte[array.length];
		for (int i = 0; i < array.length; i++)
	...
	public static double[] toPrimitive(Double[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_DOUBLE_ARRAY;
	...
	public static Double[] toObject(double[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_DOUBLE_OBJECT_ARRAY;
		final Double[] result = new Double[array.length];
		for (int i = 0; i < array.length; i++)
	...
	public static float[] toPrimitive(Float[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_FLOAT_ARRAY;
	...
	public static Float[] toObject(float[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_FLOAT_OBJECT_ARRAY;
		final Float[] result = new Float[array.length];
		for (int i = 0; i < array.length; i++)
	...
	public static boolean[] toPrimitive(Boolean[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_BOOLEAN_ARRAY;
	...
	public static Boolean[] toObject(boolean[] array)
	{
		if (array == null)
			return null;
		else if (array.length == 0) return EMPTY_BOOLEAN_OBJECT_ARRAY;
		final Boolean[] result = new Boolean[array.length];
		for (int i = 0; i < array.length; i++)
