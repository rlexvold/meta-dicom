 ...
 * @version $Id: NumberRange.java,v 1.1 2008/07/14 19:24:35 rlexvold Exp $
 */
public final class NumberRange extends Range implements Serializable
{
	...
	{
		if (num == null) throw new IllegalArgumentException("The number must not be null");
		if (num instanceof Comparable == false) throw new IllegalArgumentException("The number must implement Comparable");
		if (num instanceof Double && ((Double) num).isNaN()) throw new IllegalArgumentException("The number must not be NaN");
		if (num instanceof Float && ((Float) num).isNaN()) throw new IllegalArgumentException("The number must not be NaN");
		this.min = num;
		this.max = num;
	}
	...
	/**
	 * <p>
	 * Constructs a new <code>NumberRange</code> with the specified minimum
	...
	{
		if (num1 == null || num2 == null) throw new IllegalArgumentException("The numbers must not be null");
		if (num1.getClass() != num2.getClass()) throw new IllegalArgumentException("The numbers must be of the same type");
		if (num1 instanceof Comparable == false) throw new IllegalArgumentException("The numbers must implement Comparable");
		if (num1 instanceof Double)
		{
			if (((Double) num1).isNaN() || ((Double) num2).isNaN()) throw new IllegalArgumentException("The number must not be NaN");
		} else if (num1 instanceof Float) if (((Float) num1).isNaN() || ((Float) num2).isNaN()) throw new IllegalArgumentException("The number must not be NaN");
	...
	public boolean containsNumber(Number number)
	{
		...
		if (number.getClass() != min.getClass()) throw new IllegalArgumentException("The number must be of the same type as the range numbers");
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof NumberRange == false) return false;
