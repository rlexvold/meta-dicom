...
/**
 * <p>
 * <code>DoubleRange</code> represents an inclusive range of
 * <code>double</code>s.
 * </p>
 * 
 * @author Stephen Colebourne
 * @since 2.0
 * @version $Id: DoubleRange.java,v 1.1 2008/07/14 19:24:35 rlexvold Exp $
 */
public final class DoubleRange extends Range implements Serializable
{
	...
	{
		super();
		if (Double.isNaN(number)) { throw new IllegalArgumentException("The number must not be NaN"); }
		this.min = number;
		this.max = number;
	}
	...
	{
		super();
		if (number == null) { throw new IllegalArgumentException("The number must not be null"); }
		this.min = number.doubleValue();
		this.max = number.doubleValue();
		if (Double.isNaN(min) || Double.isNaN(max)) { throw new IllegalArgumentException("The number must not be NaN"); }
	...
	/**
	 * <p>
	 * Constructs a new <code>DoubleRange</code> with the specified minimum
	...
	{
		super();
		if (Double.isNaN(number1) || Double.isNaN(number2)) { throw new IllegalArgumentException("The numbers must not be NaN"); }
		if (number2 < number1)
		{
			this.min = number2;
			this.max = number1;
	...
	{
		super();
		if (number1 == null || number2 == null) { throw new IllegalArgumentException("The numbers must not be null"); }
		double number1val = number1.doubleValue();
		double number2val = number2.doubleValue();
		if (Double.isNaN(number1val) || Double.isNaN(number2val)) { throw new IllegalArgumentException("The numbers must not be NaN"); }
	 ...
	 * range using <code>double</code> comparison.
	 * </p>
	 * 
	 * <p>
	...
	/**
	 * <p>
	 * Tests whether the specified <code>double</code> occurs within this
	 * range using <code>double</code> comparison.
	 * </p>
	 * 
	 * <p>
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof DoubleRange == false) { return false; }
