/* vim:set softtabstop=3 shiftwidth=3 tabstop=3 expandtab tw=72:
   $Id: Matcher.java,v 1.2 2008/10/22 06:26:48 rlexvold Exp $
...
public final class Matcher
{
	 ...
	 * @throws IOException
	 *             If <i>filename</i> cannot be read.
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Trivial implementation of a MatcherListener that simply adds incoming
	 * deltas to a List.
	 */
