	...
	public void parse(InputStream is) throws XmlRpcException
	{
		...
		synchronized (readers)
		{
			if (readers.empty())
			{
				...
				{
					throw new XmlRpcException(XmlRpcMessages.get().getString("XmlRpcParser.ReaderInstantiationError"), e);
				}
			}
			else
			{
		...
		try
		{
			...
			{
				throw new XmlRpcException(XmlRpcMessages.get().getString("XmlRpcParser.ParsingError"), e);
			}
		}
		finally
		{
