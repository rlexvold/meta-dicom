...
/**
 * <p>
 * A Struct represents an XML-RPC struct in its Java form. Essentially, it's
 * just a plain java.util.HashMap with utility methods for extracting members of
 * any of the data types supported by the XML-RPC library. The class does not
 * introduce any new field members which makes it no more expensive than a
 * regular HashMap.
 * </p>
 * 
 * <p>
 * To extract nested values from the struct, use the new simplified accessors
 * which perform the casting for you:
 * </p>
 * 
 * <pre>
...
public class XmlRpcStruct extends HashMap/* <String,Object> */
{
	 ...
	 *             if a value at the given key does not exist.
	 */
	...
	/**
	 * Returns the byte[] with the given key from the Struct, as an input stream
	 * (currently, a java.io.ByteArrayInputStream).
	 * 
	 * @param key
	 *            The key of the value to extract.
	 * 
	 ...
	 * @throws NullPointerException
	 *             if a value with the given key does not exist,
	 */
	 ...
	 * 
	 * @throws ClassCastException
	 *             if the value with the given key is not a Date.
	 */
	 ...
	 * 
	 * @throws ClassCastException
	 *             if the value with the given key is not a String.
	 */
	 ...
	 * 
	 * @throws ClassCastException
	 *             if the value with the given key is not a Struct.
	 */
	 ...
	 * The timestamp represents the number of milliseconds since midnight jan
	 * 01, 1970, as returned by Date.getTime().
	 * 
	 * @param key
	 *            The key of the value to extract.
	 * 
