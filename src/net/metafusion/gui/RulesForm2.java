...
public class RulesForm2 extends MFForm
{
	...
	public RulesForm2()
	{
		...
		// "[check id='storeCheck0' text='Delete studies older than' gap='5']",
		// "[text id='storeArg0' len='4' gap='5']",
		// "[label text='days.']",
		// });
		// appendLine(new String[] {
		// "[check id='storeCheck1' text='Disk Usage: High Water' gap='3']",
		// "[text id='storeArg1' len='4' gap='2']",
		// "[label text='% used. Low Water' gap='3']",
		// "[text id='storeArg2' len='4' gap='2']",
		// "[label text='% used.']",
		// });
		//
		//
		...
		// appendLine(new String[] {
		// "[check id='poll"+i+"' text='Poll for studies from AE' gap='5']",
		// "[text id='pollae"+i+"' len='15' gap='5']",
		// "[label text='every' gap='5']",
		// "[text id='pollmin"+i+"' len='4' gap='5']",
		// "[label text='minutes. Poll during: ' gap='5']",
		// "[combo text='"+sb.toString()+"' value='24:00' id='pollstart"+i+"'
		// width='60' gap='5']",
		// "[combo text='"+"24:00;"+sb.toString()+"' value='24:00'
		// id='pollstop"+i+"' width='60' gap='5']",
		// });
		// }
		StringBuffer sb = new StringBuffer();
		for (int i = 0; i < 24; i++)
		...
		for (int i = 0; i < ForwardRuleBean.MAX_RULE; i++)
			appendLine(new String[] { "[check id='forward" + i + "' text='Forward studies' gap='5']",
					"[combo text='Of Modality;To Radiologist;From Source;From Physician' id='type" + i + "' width='100' gap='5']", "[text id='arg" + i + "' len='15' gap='5']",
					"[label text='to AE' gap='5']", "[text id='toArg" + i + "' len='15' gap='5']",
					"[combo text='" + sb.toString() + "' value='24:00' id='start" + i + "' width='60' gap='5']",
					"[combo text='" + "24:00;" + sb.toString() + "' value='24:00' id='stop" + i + "' width='60' gap='5']", });
