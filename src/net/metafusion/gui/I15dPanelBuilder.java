...
/**
 * A general purpose panel builder that uses the {@link FormLayout} to layout <code>JPanel</code>s. In addition to its
 * superclass {@link PanelBuilder} this class provides convenience behavior to map resource keys to their associated
 * internationalized (i15d) strings when adding labels, titles and titled separators.
 * <p>
...
public class I15dPanelBuilder extends PanelBuilder
{
	...
	// Instance Creation ****************************************************
	/**
	 * Constructs an instance of <code>I15dPanelBuilder</code> for the given panel and layout.
	 * 
	 * @param panel
	...
	/**
	 * Constructs an instance of <code>I15dPanelBuilder</code> for the given layout. Uses an instance of
	 * <code>JPanel</code> as layout container.
	 * 
	 * @param layout
	 *            the form layout used to layout the container
	 * @param bundle
	...
	// Helper Code **********************************************************
	/**
	 * Looks up and answers the internationalized (i15d) string for the given resource key from the
	 * <code>ResourceBundle</code>.
	 * 
	 * @param resourceKey
	 *            the key to look for in the resource bundle
	 * @return the associated internationalized string, or the resource key itself in case of a missing resource
