 ...
 * @since 2.1
 * @version $Id: CharUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class CharUtils
{
	...
	{
		if (ch == null) { throw new IllegalArgumentException("The Character must not be null"); }
		return ch.charValue();
	}
	...
	{
		if (StringUtils.isEmpty(str)) { throw new IllegalArgumentException("The String must not be empty"); }
		return str.charAt(0);
	}
	...
	{
		if (isAsciiNumeric(ch) == false) { throw new IllegalArgumentException("The character " + ch + " is not in the range '0' - '9'"); }
		return ch - 48;
	}
	...
	{
		if (isAsciiNumeric(ch) == false) { return defaultValue; }
		return ch - 48;
	}
