 ...
 * @author Gary Gregory
 * @since 1.0
 * @version $Id: CharSetUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class CharSetUtils
{
	...
	{
		if (StringUtils.isEmpty(str) || StringUtils.isEmpty(set)) { return str; }
	...
	public static String squeeze(String str, String[] set)
	{
		if (StringUtils.isEmpty(str) || ArrayUtils.isEmpty(set)) { return str; }
	...
	public static String keep(String str, String set)
	{
		...
		if (str.length() == 0 || StringUtils.isEmpty(set)) { return ""; }
		String[] strs = new String[1];
		strs[0] = set;
	...
	{
		if (str == null) { return null; }
		if (str.length() == 0 || ArrayUtils.isEmpty(set)) { return ""; }
	 ...
	 *             if <code>searchChars</code> or <code>replaceChars</code>
	 *             is <code>null</code>
