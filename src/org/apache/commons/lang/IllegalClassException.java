 ...
 * interface). This exception supplements the standard
 * <code>IllegalArgumentException</code> by providing a more semantically rich
 * description of the problem.
 * </p>
 * 
 * <p>
 * <code>IllegalClassException</code> represents the case where a method takes
 * in a genericly typed parameter like Object (typically because it has to due
 * to some other interface it implements), but this implementation only actually
 * accepts a specific type, for example String. This exception would be used in
 ...
 * {
 * 	if (obj instanceof String == false) { throw new IllegalClassException(String.class, obj); }
 ...
 * @since 2.0
 * @version $Id: IllegalClassException.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
