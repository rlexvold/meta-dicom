 ...
 * @since 2.1
 * @version $Id: CharEncoding.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class CharEncoding
{
	 ...
	 *            name or an alias
	 * @return <code>true</code> if, and only if, support for the named
	 *         charset is available in the current Java virtual machine
	 * 
	 * @see <a
	 *      href="http://java.sun.com/j2se/1.3/docs/api/java/lang/package-summary.html#charenc">JRE
	 *      character encoding names</a>
