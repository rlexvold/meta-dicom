 ...
 * @since 2.0
 * @version $Id: FloatRange.java,v 1.1 2008/07/14 19:24:35 rlexvold Exp $
 */
public final class FloatRange extends Range implements Serializable
{
	...
	public FloatRange(Number number)
	{
		...
		if (Float.isNaN(min) || Float.isNaN(max)) { throw new IllegalArgumentException("The number must not be NaN"); }
	...
	{
		super();
		if (Float.isNaN(number1) || Float.isNaN(number2)) { throw new IllegalArgumentException("The numbers must not be NaN"); }
		if (number2 < number1)
		{
			this.min = number2;
			this.max = number1;
	...
	public FloatRange(Number number1, Number number2)
	{
		...
		if (Float.isNaN(number1val) || Float.isNaN(number2val)) { throw new IllegalArgumentException("The numbers must not be NaN"); }
	 ...
	 * range using <code>float</code> comparison.
	 * </p>
	 * 
	 * <p>
	...
	public boolean equals(Object obj)
	{
		...
		if (obj instanceof FloatRange == false) { return false; }
