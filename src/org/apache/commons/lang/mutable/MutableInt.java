 ...
 * @see Integer
 * @since 2.1
 * @version $Id: MutableInt.java,v 1.1 2008/07/14 19:24:36 rlexvold Exp $
 */
public class MutableInt extends Number implements Comparable, Mutable
{
	 ...
	 * and is an <code>MutableInt</code> object that contains the same
	...
	{
		if (obj instanceof MutableInt) { return value == ((MutableInt) obj).intValue(); }
		return false;
	}
