...
/**
 * <p>
 * Escapes and unescapes <code>String</code>s for Java, Java Script, HTML,
 * XML, and SQL.
 * </p>
 * 
 ...
 * @author Pete Gieser
 * @since 2.0
 * @version $Id: StringEscapeUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class StringEscapeUtils
{
	 ...
	 * example, it will turn a sequence of <code>'\'</code> and
	...
	public static String escapeHtml(String str)
	{
		...
		// todo: rewrite underlying method to use a Writer instead of a
		// StringBuffer
