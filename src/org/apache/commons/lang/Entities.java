 ...
 * @since 2.0
 * @version $Id: Entities.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
class Entities
{
	...
	static class LookupEntityMap extends PrimitiveEntityMap
	{
		...
		public String name(int value)
		{
			if (value < LOOKUP_TABLE_SIZE) { return lookupTable()[value]; }
	...
	static class BinaryEntityMap extends ArrayEntityMap
	{
		...
		public void add(String name, int value)
		{
			...
			if (insertAt > 0) { return; // note: this means you can't insert the
										// same value twice
			}
