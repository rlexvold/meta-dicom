...
/**
 * <p>
 * Thrown to indicate that an argument was <code>null</code> and should not
 * have been. This exception supplements the standard
 ...
 * <code>IllegalArgumentException</code>. Thus this exception would be used
 * in place of <code>IllegalArgumentException</code>, yet it still extends
 * it.
 * </p>
 * 
 * <pre>
 ...
 * {
 * 	if (str == null) { throw new NullArgumentException(&quot;str&quot;); }
 ...
 * @since 2.0
 * @version $Id: NullArgumentException.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
