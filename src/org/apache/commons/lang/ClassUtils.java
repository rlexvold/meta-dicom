 ...
 * @author Norm Deane
 * @since 2.0
 * @version $Id: ClassUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class ClassUtils
{
	...
	public static String getShortClassName(String className)
	{
		...
		if (className.length() == 0) { return StringUtils.EMPTY; }
	...
	public static boolean isAssignable(Class cls, Class toClass)
	{
		...
		if (cls.isPrimitive())
		{
			...
			if (Byte.TYPE.equals(cls)) { return Short.TYPE.equals(toClass) || Integer.TYPE.equals(toClass) || Long.TYPE.equals(toClass) || Float.TYPE.equals(toClass)
