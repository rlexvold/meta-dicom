 ...
 * @author Pete Gieser
 * @since 1.0
 * @version $Id: ExceptionUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class ExceptionUtils
{
	 ...
	 * </p>
	 */
	private static String[] CAUSE_METHOD_NAMES = { "getCause", "getNextException", "getTargetException", "getException", "getSourceException", "getRootCause",
			"getCausedByException", "getNested", "getLinkedException", "getNestedException", "getLinkedCause", "getThrowable", };
	/**
	 * <p>
	...
	public static boolean isNestedThrowable(Throwable throwable)
	{
		...
		{
			return true;
		} else if (isThrowableNested()) { return true; }
		...
		for (int i = 0, isize = CAUSE_METHOD_NAMES.length; i < isize; i++)
		{
			try
			{
				...
				if (method != null && Throwable.class.isAssignableFrom(method.getReturnType())) { return true; }
			}
			catch (NoSuchMethodException ignored)
			{
			}
	...
	{
		if (throwable == null || type == null) { return -1; }
		if (fromIndex < 0)
		{
			fromIndex = 0;
		}
		Throwable[] throwables = ExceptionUtils.getThrowables(throwable);
		if (fromIndex >= throwables.length) { return -1; }
		if (subclass)
		{
	...
	public static void printRootCauseStackTrace(Throwable throwable, PrintStream stream)
	{
		...
		if (stream == null) { throw new IllegalArgumentException("The PrintStream must not be null"); }
	...
	{
		if (throwable == null) { return; }
		if (writer == null) { throw new IllegalArgumentException("The PrintWriter must not be null"); }
		String trace[] = getRootCauseStackTrace(throwable);
		for (int i = 0; i < trace.length; i++)
		{
