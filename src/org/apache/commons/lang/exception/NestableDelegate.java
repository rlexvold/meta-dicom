 ...
 * @since 1.0
 * @version $Id: NestableDelegate.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class NestableDelegate implements Serializable
{
	...
	public int indexOfThrowable(Class type, int fromIndex)
	{
		...
		if (fromIndex >= throwables.length) { throw new IndexOutOfBoundsException("The start index was out of bounds: " + fromIndex + " >= " + throwables.length); }
		if (matchSubclasses)
		{
