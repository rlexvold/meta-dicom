 ...
 * unsuitable for dealing with large <code>Long</code>,
 * <code>BigDecimal</code> or <code>BigInteger</code> numbers.
 * </p>
 * 
 * @author <a href="mailto:chrise@esha.com">Christopher Elkins</a>
 * @author Stephen Colebourne
 * @since 1.0
 * @version $Revision: 1.1 $ $Date: 2005-04-14 00:30:28 -0400 (Thu, 14 Apr
 *          2005) $
 * 
...
public final class NumberRange
{
	...
	/**
	 * <p>
	 * Constructs a new <code>NumberRange</code> using <code>number</code>
	 * as both the minimum and maximum in this range.
	 * </p>
	 * 
	 * @param num
	...
	{
		if (num == null) { throw new NullPointerException("The number must not be null"); }
		this.min = num;
		this.max = num;
	}
	...
	public NumberRange(Number min, Number max)
	{
		...
		} else if (max == null) { throw new NullPointerException("The maximum value must not be null"); }
	...
	/**
	 * <p>
	 * Indicates whether some other <code>Object</code> is &quot;equal&quot;
	 * to this one.
	 * </p>
	 * 
	 * @param obj
