 ...
 * @since 1.0
 * @version $Id: SystemUtils.java,v 1.1 2008/07/14 19:24:33 rlexvold Exp $
 */
public class SystemUtils
{
	...
	{
		if (JAVA_VERSION_TRIMMED == null) { return 0f; }
	...
	{
		if (JAVA_VERSION_TRIMMED == null) { return 0; }
	...
	private static String getJavaVersionTrimmed()
	{
		if (JAVA_VERSION != null)
		{
			for (int i = 0; i < JAVA_VERSION.length(); i++)
			{
				...
				if (ch >= '0' && ch <= '9') { return JAVA_VERSION.substring(i); }
			}
		}
		return null;
	}
	...
	{
		if (JAVA_VERSION_TRIMMED == null) { return false; }
	...
	{
		if (OS_NAME == null || OS_VERSION == null) { return false; }
