...
public class XMLElement
{
                         ...
                         boolean   ignoreCase)
    {
        ...
        this.lineNr = 0;
        Enumeration xenum = this.entities.keys();
        while (xenum.hasMoreElements()) {
            Object key = xenum.nextElement();
        ...
        throws IOException
    {
        ...
        if (! this.attributes.isEmpty()) {
            Enumeration xenum = this.attributes.keys();
            while (xenum.hasMoreElements()) {
                writer.write(' ');
        ...
        if ((this.contents != null) && (this.contents.length() > 0)) {
            ...
            writer.write('>');
            Enumeration xenum = this.enumerateChildren();
            while (xenum.hasMoreElements()) {
                XMLElement child = (XMLElement) xenum.nextElement();
                child.write(writer);
            }
            writer.write('<'); writer.write('/');
            writer.write(this.name);
